...
describe('Designation e2e test', () => {
    ...
    it('should load Designations', () => {
        ...
        expect(designationComponentsPage.getTitle()).toMatch(/myappApp.designation.home.title/);
    });
    ...
    it('should load create Designation page', () => {
        ...
        expect(designationUpdatePage.getPageTitle()).toMatch(/myappApp.designation.home.createOrEditLabel/);
